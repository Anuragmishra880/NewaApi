            ...
            <>
                <nav className="navbar navbar-expand-lg bg-primary">
                    <div className="container-fluid">
                        <NavLink className="navbar-brand text-light" to="/">News</NavLink>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                <li className="nav-item">
                                    <NavLink className="nav-link active text-light" aria-current="page" to="/">All</NavLink>
                                </li>
                                <li className="nav-item">   <NavLink className="nav-link text-light" to="/business">Business</NavLink>  </li>
                                ...
                                <li className="nav-item">   <NavLink className="nav-link text-light" to="/health">Health</NavLink>  </li>
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li><NavLink className="dropdown-item" to="/bollywood">Bollywood </NavLink></li>
                                        <li><NavLink className="dropdown-item " to="/holywood">Hollywood</NavLink></li>


                                        <li><hr className="dropdown-divider" /></li>
                                        <li><NavLink className="dropdown-item " to="/crime">Crime</NavLink></li>
